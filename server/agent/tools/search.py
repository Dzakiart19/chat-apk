...
def info_search_web(
    ...
    Args:
        ...
        date_range: Optional time filter. One of: all, past_hour, past_day, past_week, past_month, past_year
    ...
    df_param = DATE_RANGE_MAP.get(date_range or "", "") if date_range and date_range != "all" else ""
